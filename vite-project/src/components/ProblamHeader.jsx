  ...
  return (
    <>
      ...
      <div className={style.categories}>
        <div
          className={`${style.category_card} ${currentquestion === "previous" && style.actives
            } `}
        ...
        <div
          className={`${style.category_card} ${currentquestion === "Current" && style.actives
            } `}
        ...
        <div
          className={`${style.category_card} ${currentquestion === "Upcomming" && style.actives
            } `}
      ...
      <div className={style.filters}>
        ...
        <button
          className={`${style.filter_btn} ${currentfilter === "All" && style.active
            }`}
          onClick={(event) => {
            set2("All");
            setFilters("All");
        ...
        <button
          className={`${style.filter_btn} ${currentfilter === "important" && style.active
            }`}
          onClick={(event) => {
        ...
        <button
          className={`${style.filter_btn} ${currentfilter === "Most important" && style.active
            }`}
          onClick={(event) => {
            set2("Most important");
        ...
        <button
          className={`${style.filter_btn} ${currentfilter === "Attempted" && style.active
            }`}
          onClick={(event) => {
        ...
        <button
          className={`${style.filter_btn} ${currentfilter === "Not Attempted" && style.active
            }`}
          onClick={(event) => {
